  ...
  if (task_pool_max_counter == 0)
    {
       ...
       */
      task_pool_max_counter = g_trace_define_int_counter ("GIO", "task pool max size", "Maximal number of threads in the GTask thread pool");
      tasks_running_counter = g_trace_define_int_counter ("GIO", "tasks running", "Number of running tasks in the GTask thread pool");
    }
}
